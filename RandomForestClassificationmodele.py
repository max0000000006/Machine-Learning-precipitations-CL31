...
#Suppression des profils de précipitations trop hauts qui ne sont pas percus par le CEILO
...
#Filtrage des outliers avec l'IQR
...
#Suppression du bruit avec filtre passe bas
fs = 1e6
order = 50
cutoff = 1e2
...
X_train, X_test, y_train, y_test = train_test_split(X_full, LABELS, test_size=0.3, random_state=42)
